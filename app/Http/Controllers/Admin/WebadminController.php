...
class WebadminController extends Controller {
	...
	{
        $static_pages = FrontendPage::where('status',1)->get();
        $pages = Page::where('status',1)->get();

		return view('admin.index',compact('static_pages', 'pages'));
	}
    ...
    public function save_widget(Request $request)
    {
        ...
        if($obj = Widget::find($data['id']))
        {
            ...
            $obj->save();
            return Redirect::back()->withSuccess('Widget successfully updated!');
        }
