                ...
                <div class="md:w-11/12 w-full">
                    <div class="swiper swiper-initialized swiper-horizontal swiper-backface-hidden">
                        <div class="swiper-wrapper"
                            ...
                            @foreach ($testimonials->chunk(6) as $chunk)
                                
                            
                            <div class="swiper-slide swiper-slide-active" style="width: 1070px; margin-right: 50px;">
                                <div
                                    class="grid grid-cols-2 md:grid-cols-3 gap-[25px] xl:gap-[50px] px-[10px] xl:px-[50px] py-[60px] pb-[36px]">
                                    ...
                                    <div data-aos="fade-up">
                                        <div class="testimonials-item hover:rotate-8 transition-all transition-normal">
                                            <div>
                                                <div class="testimonials-item-top flex items-center justify-between">
                                                    ...
                                                    <div class="rating flex items-center gap-[7px]">
                                                        <h5 class="text-[#000] text-[15px] font-[400] leading-[10px]">
                                                            4.9</h5><svg xmlns="http://www.w3.org/2000/svg" width="21"
                                            ...
                                            <div>
                                                <h4 class="text-[#060606] text-[16px] font-[400] leading-[22px]">{{$item->name}}</h4>
                                                <p class="text-[#5B6879] text-[12px] font-[400] leading-[22px]">{{$item->designation}}</p>
                                            </div>
                                        </div>
                                    </div>
                                    @endforeach
